  ...
  const templates = [
    {
      ...
      uses: 1247,
      description:
        "Complete push workout targeting chest, shoulders, and triceps with compound and isolation movements.",
    },
    {
      id: 2,
      ...
      uses: 1089,
      description:
        "Comprehensive pulling workout for back width, thickness, and bicep development.",
    },
    {
      id: 3,
    ...
    },
    {
      ...
      uses: 892,
      description:
        "Complete full-body workout hitting all major muscle groups with heavy compound movements.",
    },
    {
      id: 5,
      ...
      uses: 756,
      description:
        "Intense lower body workout focusing on quads, hamstrings, glutes, and calves.",
    },
    {
      id: 6,
      ...
      uses: 3421,
      description:
        "Perfect morning energizer with bodyweight exercises to start your day right.",
    },
  ];
